...
export class UserController {
    ...
    @ApiOperation({ 
        ...
        description: 'Récupère la liste des utilisateurs avec pagination. Utilisez les paramètres page et limit pour contrôler la pagination.'
    })
    ...
    async findAllPaginated(@Query() paginationDto: PaginationDto) {
      return await this.userService.findAllPaginated(paginationDto.page, paginationDto.limit);
    }
    ...
    @ApiOperation({ 
        ...
        description: 'Vérifie l\'email de l\'utilisateur en utilisant le code de vérification reçu par email'
    })
    @Post('verify-email')
    ...
    @ApiOperation({ 
        ...
        description: 'Renvoye un nouveau code de vérification à l\'adresse email spécifiée'
    })
